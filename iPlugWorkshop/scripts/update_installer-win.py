...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=iPlugWorkshop Demo Installer\n"
      else:
        line="OutputBaseFilename=iPlugWorkshop Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the iPlugWorkshop Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the iPlugWorkshop installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=iPlugWorkshop Demo installer\n"
     else:
       line="SetupWindowTitle=iPlugWorkshop installer\n"
